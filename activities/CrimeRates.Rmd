...
The year 2020 is the year with the lowest crime rate due to the COVID-19 pandemic. The 1980s-1990s are the years with the highest crime rates. This pattern matches my expextations because during the COVID-19 pandemic, everyone was stuck inside of their homes, so the sharp decrease in crime is to be expected. 
